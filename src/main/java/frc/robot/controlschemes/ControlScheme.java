...
public abstract class ControlScheme {
    ...
    public ControlScheme(DriveSubsystem _driveSubsystem, ElevatorSubsystem _elevatorSubsystem, GrabberSubsystem _grabberSubsystem, CommandJoystick _joystick, CommandXboxController _xboxController) {
        driveSubsystem = _driveSubsystem;
        grabberSubsystem = _grabberSubsystem;
        elevatorSubsystem = _elevatorSubsystem;
        m_driverController = _joystick;
        m_xboxController = _xboxController;
    }
